...
def modeling_data(cust_offer_details):
    ...
    m_data = cust_offer_details[(cust_offer_details['event_offer_received'] == 1) & (cust_offer_details['event_offer_viewed'] == 1)][['gender', 'event_offer_received', 'event_offer_viewed', 'offer_id', 'offer_type', 'duration', 'difficulty', 'reward', 'ch__email', 'ch__mobile', 'ch__social', 'ch__web', 'responded_to_offer', 'age', 'income', 'days_member']]
    ...
    model_data = data_subset.drop(columns = ['event_offer_received','event_offer_viewed','age','income', 'days_member'])
